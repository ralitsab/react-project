      ...
      <div className="shipping-address flex-1">
        ...
        {userAddress && !isEditMode ? (
          <div className="mb-4 bg-[#C9DFDA] shadow-lg rounded-2xl p-6">
            <p className="text-lg font-bold mb-1 text-mainGreen">
              Address Line 1
            </p>
            ...
            <div className="flex justify-center space-x-4">
              <button
                ...
                className=" flex-1 submit-button border-solid rounded-full font-bold text-lg text-center bg-mainGreen text-white py-2 px-10 mb-8 transition ease-in-out delay-150 hover:bg-hoverDarkGreenduration-300"
              >
                Edit
              </button>
              <button
                onClick={deleteUserAddress}
                className=" flex-1 submit-button border-solid rounded-full font-bold text-lg text-center bg-mainGreen text-white py-2 px-10 mb-8 transition ease-in-out delay-150 hover:bg-hoverDarkGreen duration-300"
              >
                Delete
              </button>
            </div>
