    ...
    <form className="space-y-6" onSubmit={submitHandler}>
      ...
      <div>
        ...
        <input
          ...
          value={values.phone}
          onChange={changeHandler}
          className="block w-full px-3 py-2 mt-1 text-gray-900 placeholder-gray-500 border border-gray-300 rounded-md focus:outline-none focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
        />
        {errors.phone && (
      ...
      <div className="flex flex-col md:flex-row gap-10 ">
        <button
          type="submit"
          className="flex rounded-full justify-center w-full px-4 py-3 text-sm font-medium text-white bg-mainGreen border border-transparent rounded-md hover:bg-hoverDarkGreen"
        >
          Submit
        </button>
        {isEditMode && (
